...
let globals = function () {
    ...
    global.PRIORITIES = {
        ...
        // Remotes
        remHarvester: 3, remHauler: 3, roadBuilder: 4, fuelTruck: 8, reserver: 4,
        // Military
        defender: 2, extreme: 3, priority: 4, urgent: 5, high: 6, medium: 7, secondary: 9
    };

    global.REMOTE_SOURCE_TARGET = 6; // The number of remote sources a room looks to have (5). Changing this might ruin your economy.
