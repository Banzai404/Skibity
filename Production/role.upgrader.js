    ...
    if (creep.memory.herald) {
        ...
        if (creep.room.memory.lowPower) {
            ...
            if (INTEL[creep.room.name].threatLevel) {
                if (INTEL[creep.room.name].threatLevel === 1) sentence = sentence.concat(['DEFCON 4']);
                if (INTEL[creep.room.name].threatLevel === 2) sentence = sentence.concat(['DEFCON 3']);
                if (INTEL[creep.room.name].threatLevel === 3) sentence = sentence.concat(['DEFCON 2']);
                if (INTEL[creep.room.name].threatLevel >= 4) sentence = sentence.concat(['DEFCON 1']);
                ...
                sentence = sentence.concat(['DEFCON 5']);
            }
