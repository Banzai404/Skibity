...
module.exports.role = function (creep) {
    ...
    if (creep.memory.onContainer) {
        ...
        if (source) {
            ...
            switch (creep.harvest(source)) {
                ...
                case OK:
                    ...
                    if (!creep.memory.setSourceAmount) {
                        ...
                        source.memory.carryAmountNeeded = _.round((travelRange * (creep.getActiveBodyparts(WORK) * HARVEST_POWER)) * 1.2 );
            ...
            let oldestHarvester = _.min(_.filter(creep.room.creeps, (c) => c.memory && c.ticksToLive < 500 && c.memory.role === "remHarvester"), "ticksToLive");
